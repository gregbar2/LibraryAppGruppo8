...
export default function AppTabs() {
  return (
    <Tab.Navigator initialRouteName="Homepage">
      <Tab.Screen name="Homepage" component={Homescreen} options={/* options è un obj che ci permette di personalizzare la tab.screen, definiamo una funzione per restituire tutte le proprietà imposte e per gestire il controllo per nascondere la tabBar*/
      ({ route }) => {
